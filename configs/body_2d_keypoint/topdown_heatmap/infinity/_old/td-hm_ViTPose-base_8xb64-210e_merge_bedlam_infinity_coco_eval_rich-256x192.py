...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            entity="yonigoz",
            name="merge_bedlam_infinity_coco_eval_rich/ViT/base_pretrained",
        ),
    ),
]
visualizer = dict(
...
work_dir = "/scratch/users/yonigoz/mmpose_data/work_dirs/merge_bedlam_infinity_coco_eval_rich/ViT/base_pretrained"
