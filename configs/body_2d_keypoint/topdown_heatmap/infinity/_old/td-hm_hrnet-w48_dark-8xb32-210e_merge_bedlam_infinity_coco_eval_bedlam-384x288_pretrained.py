...
combined_dataset = dict(
    ...
    datasets=[dataset_infinity, dataset_bedlam, dataset_coco],
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            entity="yonigoz",
            name="merge_bedlam_infinity_coco_eval_bedlam/HRNet/w48_dark_pretrained",
        ),
    ),
]
visualizer = dict(
...
work_dir = "/scratch/users/yonigoz/mmpose_data/work_dirs/merge_bedlam_infinity_coco_eval_bedlam/HRNet/w48_dark_pretrained"
