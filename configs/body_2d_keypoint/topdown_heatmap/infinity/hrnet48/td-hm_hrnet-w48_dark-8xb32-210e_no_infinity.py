...
combined_dataset = dict(
    ...
    datasets=[dataset_bedlam, dataset_3DPW, dataset_coco],
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            entity="yonigoz",
            name="no_infinity/HRNet/w48_dark_pretrained",
        ),
    ),
]
visualizer = dict(
...
work_dir = "/scratch/users/yonigoz/mmpose_data/work_dirs/no_infinity/HRNet/w48_dark_pretrained"
