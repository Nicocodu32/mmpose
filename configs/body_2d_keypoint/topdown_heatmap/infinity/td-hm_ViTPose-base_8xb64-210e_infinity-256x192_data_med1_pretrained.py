...
data_root = "../combined_dataset_medium_1"
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            entity="yonigoz",
            name="infinity/ViT/base_med1_pretrained",
        ),
    ),
]
visualizer = dict(
...
work_dir = (
    "/scratch/users/yonigoz/mmpose_data/work_dirs/infinity/ViT/base_med1_pretrained"
)
