...
@DATASETS.register_module(name="BEDLAMDataset")
class BEDLAMDataset(BaseCocoStyleDataset):
    METAINFO: dict = dict(from_file="configs/_base_/datasets/BEDLAM.py")
    def __init__(self,
                 ann_file: str = '',
    ...
    def _load_annotations(self) -> Tuple[List[dict], List[dict]]:
        ...
        self.bedlam_keypoints_name = self.coco.loadCats(0)[0]["augmented_keypoints"]
    ...
    def parse_data_info(self, raw_data_info: dict) -> Optional[dict]:
        ...
        for ipt, name in enumerate(self.bedlam_keypoints_name):
