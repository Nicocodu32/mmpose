...
@DATASETS.register_module(name="Halpe26augDataset")
class Halpe26augDataset(BaseCocoStyleDataset):
    METAINFO: dict = dict(from_file="configs/_base_/datasets/halpe26aug.py")
    def __init__(self,
                 ann_file: str = '',
    ...
    def _load_annotations(self) -> Tuple[List[dict], List[dict]]:
        ...
        self.halpe26aug_keypoints_name = self.coco.loadCats(0)[0]["augmented_keypoints"]
    ...
    def parse_data_info(self, raw_data_info: dict) -> Optional[dict]:
        ...
        for ipt, name in enumerate(self.halpe26aug_keypoints_name):
